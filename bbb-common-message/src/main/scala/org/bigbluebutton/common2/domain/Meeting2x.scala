...
case class SimplePollResultOutVO(id: String, questionType: String, questionText: Option[String], answers: Array[SimpleVoteOutVO], correctAnswer: Option[String], numRespondents: Int, numResponders: Int)
