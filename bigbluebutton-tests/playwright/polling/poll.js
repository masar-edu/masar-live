...
class Polling extends MultiUsers {
  ...
  async smartSlidesQuestions() {
    ...
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'E. Gummy bears');
    await this.modPage.waitAndClick(e.publishPollingLabel);
    ...
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'A. Sodium');
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'B. Calcium');
    await this.modPage.waitAndClick(e.publishPollingLabel);
    await this.modPage.wasRemoved(e.pollingContainer, 'should not display the polling container after the poll is published');
    ...
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'True');
    await this.modPage.waitAndClick(e.publishPollingLabel);
    ...
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'Yes');
    await this.modPage.waitAndClick(e.publishPollingLabel);
    ...
    await this.userPage.waitAndClick(e.pollSubmitAnswer);
    await this.modPage.hasText(e.userVoteLiveResult, e.answerMessage, 'should display the answer sent by the attendee');
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'All good!');
    await this.modPage.waitAndClick(e.publishPollingLabel);
    await this.modPage.wasRemoved(e.pollingContainer, 'should close the polling container after publishing the label');
    ...
    await this.modPage.hasElementCount(e.userVoteLiveResult, 1, '', 'D. Very confident');
    await this.modPage.waitAndClick(e.publishPollingLabel);
    await this.modPage.wasRemoved(e.pollingContainer, 'should not display the polling container after the poll is published');
